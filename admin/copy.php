    ...
    if(isset($_SESSION['Username'])){
        ...
        if ($do == 'Manage') {          // Mange Page 
            ...
            $stmt = $con->prepare(" SELECT  BloodCenter.id, BloodCenter.name, BloodCenter.address,
                                            ...
                                            BloodCenterType.name AS type, Distirct.name AS district
                                    FROM    BloodCenter, BloodCenterType, Country, Distirct 
                                    WHERE   BloodCenter.countryid = Country.id && 
                                            BloodCenter.bloodCenterTypeid = BloodCenterType.id && 
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row" id="main">
                    <!-- Page Heading -->
                    <div class="go-title">
                        <div class="pull-right"><a href="bloodcenters.php?do=Add"><div class="btn btn-primary"><i class="fa fa-plus"></i> Add New Center</div></a></div>
                        <h3>Manage Blood Centers</h3>
                                ...
                                <?php
                                    foreach($rows as $row) {
                                        echo '<tr>';
                                            ...
                                            echo '<td>' . $row['type']. '</td>';
                                            echo '<td>  
                                                <a href="bloodcenters.php?do=Edit&centerid='. $row['id'] .'" style="padding:5px" class="btn btn-success"><i class="fa fa-edit"></i> Edit</a>
                                                <a href="bloodcenters.php?do=Delete&centerid='. $row['id'] .'" style="padding:5px" class="btn btn-danger confirm"><i class="fa fa-close"></i> Delete</a> ';
                                                
                                                if($row['registrationApproved'] == 0) {
                                                    echo '<a href="bloodcenters.php?do=Activate&userid='. $row['id'] .'" style="padding:5px" class="btn btn-info"><i class="fa fa-close"></i> Activate</a>';
                                                }
